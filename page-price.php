...
<img src="<?php echo $img_url; ?>price_card_1.png" alt="初期費用">
...
<img class="d-md-block d-none mx-auto" src="<?php echo $img_url; ?>price_table_pc.png" alt="">
<img class="d-md-none d-block mx-auto" src="<?php echo $img_url; ?>price_table_sp.png" alt="">
</div>
...
<img class="d-block mx-auto" src="<?php echo $img_url; ?>price_sample_1.png" alt="">
</div>
<div class="col-md">
<img class="d-block mx-auto" src="<?php echo $img_url; ?>price_sample_2.png" alt="">
</div>
</div>
</div>
